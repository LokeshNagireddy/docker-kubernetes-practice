...
* Eksctl
  - eksctl is the command line that work with AWS command line to create kubernetes cluster.
  - First it check for Authentication, therefore an IAM user with least permissions is required.
* AWS CLI V2
* Kubectl
